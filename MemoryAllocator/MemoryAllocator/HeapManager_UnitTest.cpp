...
bool HeapManager_UnitTest()
{
	...
	do
	{
		...
		//void * pPtr = HeapManager::_alloc(pHeapManager, sizeAlloc, alignment);
		//void * pPtr = HeapManager::_alloc(sizeAlloc, alignment);
		void * pPtr =pHeapManager->_alloc(pHeapManager, sizeAlloc, alignment);
		...
		if (pPtr == nullptr)
		{
			...
			pPtr = pHeapManager->_alloc(pHeapManager, sizeAlloc, alignment);
#else
	...
	if (!AllocatedAddresses.empty())
	{
		...
		void * pPtr = pHeapManager->alloc(pHeapManager, sizeHeap / 2);
		assert(pPtr);
